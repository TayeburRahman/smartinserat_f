const myTheme = {
  ...
  button: {
    ...
    primary: {
      base: "text-white bg-royalPurple border border-transparent",
      active:
        "active:bg-royalPurple-dark hover:bg-royalPurple-light focus:ring focus:ring-blue-300",
      disabled: "opacity-50 cursor-not-allowed",
    },

    outline: {
      base: "text-royalPurple  border-royalPurple-light border bg-white dark:text-gray-400 focus:outline-none",
      active:
    ...
    link: {
      base: "text-gray-600 dark:text-gray-400 focus:outline-none border border-transparent bg-transparent",
      active:
        "active:bg-transparent focus:ring focus:ring-gray-300 hover:text-royalPurple-light hover:ring-royalPurple dark:hover:text-gray-300",
      disabled: "opacity-50 cursor-not-allowed",
    },
